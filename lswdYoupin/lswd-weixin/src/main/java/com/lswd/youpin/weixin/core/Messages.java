...
import com.lswd.youpin.common.xml.XmlReaders;
...
import com.lswd.youpin.weixin.model.message.receive.event.*;
import com.lswd.youpin.weixin.model.message.receive.msg.*;
import com.lswd.youpin.weixin.model.message.resp.Article;
import com.lswd.youpin.weixin.model.message.resp.RespMessageType;
import com.lswd.youpin.weixin.model.message.send.*;
import com.lswd.youpin.weixin.utils.XmlWriters;
...
public final class Messages extends Component {
    ...
    private RecvMessage parse2RecvMessage(XmlReaders readers) {
        ...
        m.setCreateTime(readers.getNodeLong("CreateTime"));
