package com.lswd.youpin.poiutils;
...
public class ExportUtil {
    ...
    public ExportUtil(String fileDir, String sheetName) {
        this.fileDir = fileDir;
        this.sheetName = sheetName;
        workbook = new HSSFWorkbook();
    }

    public ExportUtil(HttpServletResponse response, String fileName, String sheetName) {
